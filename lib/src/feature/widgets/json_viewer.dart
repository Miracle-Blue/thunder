...
/// Main widget that displays a JSON structure in a
/// hierarchical and interactive way.
class JsonViewer extends StatelessWidget {
  ...
  /// Determines the type of JSON content and
  /// delegates to the appropriate viewer.

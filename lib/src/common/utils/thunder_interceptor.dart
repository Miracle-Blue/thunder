      ...
      (request, context) async {
        ...
        try {
          ...
          onNetworkActivity(ThunderNetworkLog(
            ...
            response: response,
            duration: duration,
            receiveBytes: utf8.encode(response.body.toString()).length,
            sendBytes: utf8
                .encode((response.request as Request).bodyBytes.toString())
                .length,
          ));
          ...
          onNetworkActivity(ThunderNetworkLog(
            ...
            sendBytes:
                utf8.encode((request as Request).bodyBytes.toString()).length,
          ));
